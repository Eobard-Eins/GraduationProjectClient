...
class HorizontalButton extends StatelessWidget{
  ...
  HorizontalButton({required this.text,this.icon,this.iconSuffix,required this.onTap,this.height,this.iconSize,this.fontSize,this.needDivider=true});
    ...
    return Column(children: [
      InkWell(
        ...
        child: SizedBox(
          ...
          child: Row(
            children: [
                Padding(padding: const EdgeInsets.only(right: 10),child: iconA==null?null:Icon(iconA,color: Coloors.greyDeep,size:iconSize),),
